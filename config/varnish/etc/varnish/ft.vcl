...
sub vcl_recv {
    ...
    set req.http.Country-Code = country.lookup("country/iso_code", std.ip(req.http.X-Real-IP, "127.0.0.1"));

    if (req.http.Country-Code == "CN" ) {
        return (synth(403, "Sorry, not available in your country"));
